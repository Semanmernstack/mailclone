...
function SendMail() {
  ...
  return (
    <div className=" flex absolute bottom-0 p-2 ml-2 mb-2 flex-col max-width-[350px] bg-slate-900 text-white">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col p-2 text-lg " >
                <input type="text"
                    name="to"
                    placeholder='to'
