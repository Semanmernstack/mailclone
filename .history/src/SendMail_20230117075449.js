  ...
  return (
    <div className=" flex absolute bottom-0 p-2 ml-2 mb-2 flex-col max-width-[350px] h-[300px] w-[300px] bg-slate-900 text-white">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col p-2 " >
                <input type="emails"
                    placeholder='to'
                    className='h-7 border-b-2 flex-1 my-3 border-none outline-none hover:bg-zinc-900 '
                ...
                <input type="text"
                    placeholder='message'
                    className='h-[200px] border-b-2 flex-1 my-3  border-none outline-none hover:bg-zinc-900 '
